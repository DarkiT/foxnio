...
#[cfg(test)]
mod tests {
    use crate::gateway::{failover::FailoverConfig, SseEvent, UpstreamEndpoints};

    #[test]
    fn test_upstream_endpoints() {
        assert_eq!(UpstreamEndpoints::anthropic(), "https://api.anthropic.com");
        assert_eq!(UpstreamEndpoints::openai(), "https://api.openai.com");
        assert_eq!(
    ...
    fn test_openai_stream_chunk() {
        ...
        assert_eq!(
            OpenAIStreamParser::extract_delta(&chunk),
